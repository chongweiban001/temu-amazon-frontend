 ...
 * @param {NodeList} rows - 所有行元素
 * @param {number} page - 当前页码
 * @param {number} rowsPerPage - 每页显示行数
 */
...
/**
 * 显示产品列表指定页
 * @param {NodeList} productItems - 所有产品项元素
 * @param {number} page - 当前页码
 ...
 * @param {Function} callback - 页面切换回调函数
 */
 ...
 * @param {boolean} isNavButton - 是否是导航按钮（上一页/下一页）
 * @param {boolean} isActive - 是否是当前活动页
 * @returns {HTMLElement} - 创建的分页项元素
 */
